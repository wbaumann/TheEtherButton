  ...
  render() {
    return (
      <div className="hero">
        ...
        <p className="subtitle">You will be awarded a unique <a target="_blank" rel="noopener noreferrer" href="http://erc721.org/">ERC-721 token</a> flair based on how close the counter is to Block 0 when you click the button below. This token is yours to sell, collect, or trade. But you may only press the button once. And the block counter will reset to 20 as soon as you do. Choose wisely...</p>
      </div>
    );
  }
}
